...
const PokemonDetailPage = async ({ params }: { params: { id: string } }) => {
  ...
  return (
    <main className="flex bg-gray-500 min-h-screen flex-col items-center justify-between p-24">
      <div className="pokemon-details max-w-xl mx-auto bg-gray-300 shadow-lg rounded-lg overflow-hidden">
        <div className="bg-gray-400 text-gray-800 text-center p-4">
        ...
        <div className="p-4 text-black flex flex-col justify-start items-center">
          ...
          <div className="text center mt-4">
            <Link href="/" className="bg-blue-400 text-white px-4 py-2 rounded">
              뒤로가기
            </Link>
          </div>
        </div>
